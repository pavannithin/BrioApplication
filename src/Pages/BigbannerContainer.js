...
function showImage(isDeskTopDevice) {
  if (isDeskTopDevice) {
    return <>
      <Grid xs sx={{ width: '100vh', height: '48vh', backgroundColor: 'white', padding: '1vh', border: '1px solid grey' }}>
      {/* <Paper sx={{ height: '100%', backgroundImage: `url(${companyprofile})`, backgroundSize: 'cover', borderRadius: '1vh' }} /> */}
      <>Space Filler : Banner for company details , product detailing and broucher downloades </>
      </Grid>
    </>
  } else {
...
function Bigbanner(props) {
  return (
    <Grid container sx={{ height: '50vh', alignItems: 'center' }}>
