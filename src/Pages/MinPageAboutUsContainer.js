...
function MinPageAboutUsContainer(props) {
  return (
    <Grid sx={{height: '50vh', width: '100%', dispaly: 'flex', justifyContent: 'center', padding: '10vh 6vh 10vh 6vh', textAlign: 'center', fontFamily: 'Roboto,Sans-serif' }}>
      <Typography variant='h4' sx={{ paddingBottom: '5vh', color: HeaderColor }}>About Us</Typography>
