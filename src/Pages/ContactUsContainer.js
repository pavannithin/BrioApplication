...
function contactDetails() {
  return <Box sx={{ display: 'flex', alignItems: 'center' }}>
    <Grid>
      ...
      <Grid item paddingLeft='4vh'><img height='100vh' src="https://www.transparentpng.com/thumb/telephone/yellow-old-phone-png-transparent-images--32.png" alt="yellow old phone png transparent images @transparentpng.com" /></Grid>
...
function ContactUsContainer(props) {
  return (
    <Grid sx={{ display: 'flex', height: '45vh', justifyContent: 'space-evenly', border: '1px solid #ebe7df', borderRadius: '1vh', backgroundColor: '#ebe7df' }}>
